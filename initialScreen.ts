...
function renderStartScreen() {
    ...
    function setDifficulty(event: Event) {
        ...
        if (datasetDifficulty === undefined) throw new Error('что- то произошло с заданием сложности игры внутри HTML элемента')
        if (datasetDifficulty in cardsCountByDifficulty) {
            difficulty = cardsCountByDifficulty[datasetDifficulty as keyof typeof cardsCountByDifficulty]
            return
        }
